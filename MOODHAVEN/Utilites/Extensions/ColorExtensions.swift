...
extension Color {
    ...
    static let set8 = Color("set 8")
    static let set9 = Color("set 9")
    static let set10 = Color("set 10")
    // --------------------------------
    static let fg0 = Color("fg 0")
    ...
    static let fg8 = Color("fg 8")
    static let fg9 = Color("fg 9")
    static let fg10 = Color("fg 10")
